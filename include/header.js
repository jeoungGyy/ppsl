...
str += '            </ul>';
str += '          </li>';
str += '          <li style="display:none !important;"><a href="HO_00_02_01.html" data-menu="depth_8"><span>로그인</span></a>';
str += '            <ul class="depth2">';
...
str += '        <div style="display:none"><h2>전체메뉴</h2></div>';
str += '        <div ><p class="loginName"><b>홍길동</b><span>님 안녕하세요.</span></p><div class="loginSpace"><span>로그인유지</span><span class="time">29:59</span><button type="button" class="timeExtensionBtn">시간연장</button></div></div>';
str += '      </div>';
str += '    </div>';
str += '  </header>';
