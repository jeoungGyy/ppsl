...
str += '            <ul class="depth2">';
str += '              <li><a href="../charge/HO_04_01_01_01.html" data-menu="depth_4_1"><span>연계급여청구</span></a></li>';
str += '              <li><a href="../charge/HO_04_02_01.html" data-menu="depth_4_2"><span>청구인 정보변경</span></a></li>';
str += '              <li><a href="../charge/HO_04_03_01.html" data-menu="depth_4_3"><span>수급계좌 정보변경</span></a></li>';
str += '              <li><a href="../charge/HO_04_04_01.html" data-menu="depth_4_4"><span>청구상태조회</span></a></li>';
str += '            </ul>';
str += '          </li>';
...
str += '              <li><a href="#" data-menu="depth_7_2"><span>홈페이지 이용안내</span></a></li>';
...
str += '        <!-- 로그인 시 --><div><p class="loginName layerTitle" tabindex="0"><b>홍길동</b><span>님 안녕하세요.</span></p><div class="loginSpace"><span>로그인유지</span><span class="time">29:59</span><button type="button" class="timeExtensionBtn">시간연장</button></div></div>';
str += '      </div>';
str += '    </div>';
str += '  </header>';
